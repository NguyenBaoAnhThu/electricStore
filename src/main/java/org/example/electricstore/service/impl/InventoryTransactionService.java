...
public class InventoryTransactionService implements IInventoryTransactionService
    ...
    @Override
    public Page<InventoryTransaction> searchTransactions(String field, String keyword, int page, int size, LocalDate fromDate, LocalDate toDate, String transactionType) {
        return null;
    }
